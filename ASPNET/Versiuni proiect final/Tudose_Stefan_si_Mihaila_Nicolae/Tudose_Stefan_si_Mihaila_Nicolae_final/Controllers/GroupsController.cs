...
namespace Proiect.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.maine = DateTime.Now.AddDays(1).Ticks;
            return View();
        }
        ...
        public IActionResult Edit(int id)
        {
            ...
            {
                TempData["message"] = "You dont have sufficient permissions";
...
/*
    Validare custom sa fie data viitoare

    [Required(ErrorMessage = "Pleaese enter a value for the gift card date")]
    [DataType(DataType.DateTime)]
    [CustomValidation(typeof(GiftCard), "ValidationDate"]
    public DateTime DataExp {get; set;}

    public static ValidationResult ValidationDate(DateTime? date){
        if (date == null){
    ...
    Motor de cautare foarte rudimentar
