...
namespace Proiect.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet <PendingUserGroup> PendingUserGroups { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PendingUserGroup>()
            .HasKey(m => new { m.User_ID, m.Group_ID });
            ...
            modelBuilder.Entity<PendingUserGroup>()        ///PendingUserGroup
            .HasOne(m => m.User)
            .WithMany(m => m.PendingUserGroups)
            .HasForeignKey(m => m.User_ID);
            modelBuilder.Entity<PendingUserGroup>()
            .HasOne(m => m.Group)
            .WithMany(ab => ab.PendingUserGroups)
            .HasForeignKey(ab => ab.Group_ID);

            modelBuilder.Entity<Message>()          ///Messages
             .HasOne(m => m.Group)
